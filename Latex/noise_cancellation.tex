...
\end{align}
Das folgende Matlab Programm \ref{sec:ListingLevinsonDurbin} implementiert den Levinson-Durbin-Algorithmus. Zuerst werden die Variablen mit 0 initialisiert. Der Startwert für $\alpha$
...
\begin{figure}[H]
\centering
%\includegraphics[trim=5mm 3mm 5mm 3mm, clip=true, width=14cm]{mse.pdf}
\includegraphics[width=10cm]{Prediction/mse.pdf}
\caption{Beispiel mittlerer quadratische Fehler mit einer Ordnung von N=1}
\label{fig:mseexample}
\end{figure}
\noindent
...
\end{equation}
Um die Unterschiede der verschiedenen Optimierungen darzustellen soll ein mittelwertfreies Rauschsignal mit unterschiedlicher Amplitude erzeugt werden (s. Abbildung \ref{fig:varianzmittelwertfrei}).
\begin{figure}[h]
\centering
%\includegraphics[trim=5mm 3mm 5mm 3mm, clip=true, width=14cm]{mse.pdf}
\includegraphics[trim=20mm 75mm 20mm 70mm, clip, width=12cm]{Prediction/Varianz_mittelwert_frei.pdf}
\caption{Beispiel mittelwertfreies Rauschsignal mit unterschiedlicher Amplitude und deren gleitender Varianz mit $N=50$.}
\label{fig:varianzmittelwertfrei}
\end{figure}
...
\end{equation}
Zur Demonstration wie unterschiedlich die Varianz ausfällt wenn der Mittelwert nicht berücksichtigt wird zeigt Abbildung \ref{fig:varianzmittelwertfrei} mitte. Das Ausgangssignal ist das gleiche Rauschsignal wie in Abbildung \ref{fig:varianzmittelwertfrei} oben dargestellt nur mit einem zeitlich begrenzten Offset zwischen Zeitpunkt 100 und 150 mit einer Amplitude von 500.
\begin{figure}[H]
\centering
%\includegraphics[trim=left bottom right top, clip]
\includegraphics[trim=20mm 70mm 20mm 70mm, clip, width=12cm]{Prediction/Varianz_mittelwert.pdf}
\caption{Beispiel mittelwertbehaftetes Rauschsignal und deren gleitender Varianz mit $N=50$.}
\label{fig:varianzmittelwertfrei}
\end{figure}
...
\centering
%\includegraphics[trim=5mm 3mm 5mm 3mm, clip=true, width=14cm]{mse.pdf}
\includegraphics[trim=25mm 75mm 25mm 73mm, clip=true, width=12cm]{Prediction/ecg_signal_with_noise.pdf}
\caption{EKG-Signal mit überlagertem 50Hz Netzbrummen als Störsignal}
\label{fig:ecg_signal_with_noise}
\end{figure}
\noindent
...
\centering
%\includegraphics[trim=5mm 3mm 5mm 3mm, clip=true, width=14cm]{mse.pdf}
\includegraphics[trim=25mm 75mm 25mm 73mm, clip=true, width=12cm]{Prediction/ecg_signal_without_noise.pdf}
\caption{EKG-Signal störbefreit mittels adaptiver Prädiktion}
\label{fig:ecg_signal_without_noise}
\end{figure}
\noindent
...
\centering
%\includegraphics[trim=5mm 3mm 5mm 3mm, clip=true, width=14cm]{mse.pdf}
\includegraphics[trim=25mm 75mm 25mm 70mm, clip, width=10cm]{Prediction/ecg_signal_decorrelated.pdf}
\caption{Dekorreliertes EKG-Signal}
\label{fig:ecg_signal_decorrelated}
\end{figure}
\noindent
...
\begin{figure}[H]
\centering
\includegraphics[trim=25mm 75mm 25mm 73mm, clip=true, width=10cm]{Prediction/ecg_signal_quant_decorrelated.pdf} % left bottom right top
%\includegraphics[width=12cm]{ecg_signal_quant_decorrelated.pdf}
\caption{Dekorreliertes, quantisiertes EKG-Signal}
\label{fig:ecg_signal_quant_decorrelated}
\end{figure}
\noindent
...
\begin{figure}[H]
\centering
\includegraphics[trim=25mm 75mm 25mm 73mm, clip=true, width=10cm]{Prediction/ecg_signal_quant_back_correlated.pdf} % left bottom right top
\caption{Rückgewonnenes EKG-Signal nach quantisierter Dekorrelation}
\label{fig:ecg_signal_quant_back_correlated}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[trim=25mm 70mm 25mm 73mm, clip=true, width=10cm]{Prediction/ecg_signal_quant_back_correlated_poles.pdf} % left bottom right top
\caption{Pol-Nullstellen-Diagramm des IIR-Filters zur Signalrückgewinnung}
\label{fig:ecg_signal_quant_back_correlated_poles}
\end{figure}
