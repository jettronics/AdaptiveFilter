...
\begin{tikzpicture}
	...
	\matrix (m1) [row sep=2.5mm, column sep=5mm]
	{
		...
		\node[dspnodefull]                  (m22) {};          &
		\node[coordinate]                  (m23) {};          &
		\node[dspsquare, minimum size=1cm, , inner xsep=10pt]                  (m24) {Filter};          &
		\node[coordinate]                 (m25) {};          &
		\node[dspadder]                    (m26) {};          &
		\node[dspnodefull]                 (m27) {};          &
		\node[coordinate]                   (m28) {}; &
...
\section{Least Mean Square algorithm}
...
\begin{equation}
\frac{\partial E(e_k^2) }{\partial \textit{\textbf{b}}_k}= -2 \underbrace{E(\textit{\textbf{X}}_k)}_\text{\clap{no mean value}}+2 \textit{\textbf{b}}_k E(\textit{\textbf{X}}_k^2)\nonumber
\end{equation}
